...
function HotManga({ mangas, page, totalMangas }) {
  ...
  const handlePageChange = (e) => {
    ...
    if (mangas && e.selected !== 0) {
      navigate(`/hot?page=${e.selected + 1}`);
    } else {
      navigate();
    }
  };
            ...
            <div className="items">
              <div className="relative">
                <h1 className="page-title">
                  Truyện hot <i className="fa fa-angle-right" />
                </h1>
              </div>
              <div className="row">
                {mangas?.length > 0 ? (
